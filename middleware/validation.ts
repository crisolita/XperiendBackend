...
export const querySchemaUpdateProjectEscenario = Joi.object({
  project_id: Joi.number().required(),
  escenario: Joi.string()
    .valid("CONSERVADOR", "MODERADO", "FAVORABLE")
    .required(),
...
export const querySchemaUpdateProjectUserSaleManage = Joi.object({
  project_id: Joi.number().required(),
  tipoDeUser: Joi.string()
    .valid("REGULAR", "PREMIUM", "PREMIUMGOLD")
    .required(),
...
export const querySchemaUpdateProjectTemplate = Joi.object({
  ...
  document_type: Joi.string()
    .valid("COMPRA", "INTERCAMBIO", "RECOMPRA", "RECLAMACION", "REINVERSION")
    .required(),
});
...
export const querySchemaUpdateKycStatus = Joi.object({
  ...
  status: Joi.string().valid("APROBADO", "RECHAZADO", "PENDIENTE").required(),
  motivo_rechazo_kyc: Joi.string(),
});

export const querySchemaChangeAdmin = Joi.object({
  user_id: Joi.number().required(),
  rol: Joi.string().valid("CLIENT", "ADMIN").required(),
});
...
export const querySchemaSubmitKyc = Joi.object({
  ...
  cuenta_bancaria: Joi.string().required(),
  postalCode: Joi.string().required(),
  state: Joi.string().required(),
  country: Joi.string().required(),
  nivel_inversion: Joi.string().valid(
    "A_0_10000",
    "B_10_50000",
    "C_50000_100000",
    "D_100000"
...
export const querySchemaGestionVisibilidad = Joi.object({
  ...
  rol: Joi.string()
    ...
    .required(),
  user_rol_visible: Joi.string().valid("CLIENT", "OWNER", "KYC").required(),
  visible: Joi.boolean().required(),
});

export const querySchemaUpdateKyc = Joi.object({
  name: Joi.string(),
  cuenta_bancaria: Joi.string(),
  residencia_fiscal: Joi.string(),
  lastname: Joi.string(),
  country_born: Joi.string(),
  birth: Joi.date(),
