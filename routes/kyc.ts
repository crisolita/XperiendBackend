...
import { querySchemaSubmitKyc, querySchemaUpdateKyc } from "../middleware/validation";
...
router.put("/updateKYC",validator.body(querySchemaUpdateKyc), authenticateToken, updateKYC);
