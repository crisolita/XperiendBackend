...
export async function sendCompraTransferenciaEmail(email: string,username:string,numeroDecuenta:string,banco:string,titular:string,concepto:string) {
  const mailData = {
    from: process.env.EMAILADDRESS, // sender address
    to: email, // list of receivers
                              ...
                              <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                                <tr>
                                  <td class="bodyTitle" id="bodyText-8"><p><br></p>
                                    ...
                                    <br>Titular de la Cuenta: ${titular}
                        ...
                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="640" style="width: 640px; min-width: 640px;" class="mlContentTable ">
                          <tr>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                              <tr>
                                <td align="left" class="bodyTitle">
                                  <h1>Un pequeño clic para ti, <span class="colores">un gran paso para tu cartera.</span></h1>
                                </td>
                              </tr>
                            </table>
                            ...
                            <td align="center" style="padding: 0px 40px;" class="mlContentOuter">
                              <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                                <tr>
                                  <td class="bodyTitle" id="bodyText-8"><p><br></p>
                                    <p>¡Hola ${username}!</p>
                                    <p><br>Un pequeño clic para ti, un gran paso para tu cartera. </p>
                                    <p><br>¡Felicidades! Ya eres miembro oficial del Club XPERIEND, donde solo los valientes se atreven a apostar por el éxito. Sabemos que este club no es para todos, pero si estás aquí, es porque realmente conoces el secreto para apostar y ganar.</p>
                                    <p><br>Este solo es el primer paso, ahora te toca entrar en la APP y estar pendiente de las próximas oportunidades de inversión que te ofrecemos para empezar a ver crecer tu dinero.</p>
                                    <p><br>Oportunidades seguras a las que puedes acceder de forma fácil, sencilla y únicas.</p>
                                    <p><br>Una vez más, ¡bienvenido al club de inversiones donde tus sueños financieros se hacen realidad!</p>
                                    <p><br>Un abrazo,</p>
                                    <p>Equipo XPERIEND</p>
                                  </td>
                                </tr>
